...
class TableComponents extends React.Component {
    render() {
        const { columns = [], rowSelection, expandedRowRender } = this.props;
        ...
        // 在结尾 或者 操作列前面增加一列不定宽的列，用于动态伸缩
        {
            ...
            // 最后一列是浮动的情况
            if (columnsTemp[columnsTemp.length - 1] !== null &&
        ...
        return (<Table {...this.props} columns={columnsTemp} scroll={{ x: tableWidth }} rowSelection={rowSelection}/>);
    }
}
