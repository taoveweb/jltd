...
export function formatter(data:any, parentPath = '/', parentAuthority:any) {
...
export function formatterMenuData(data:any, parentPath = '/') {
  return data.map((item:any) => {
    let { menuUrl } = item;
...
export function changeMenus(tempMenus:any) {
