...
const styles = require('./SelectComponents.less');
...
class SelectComponents extends React.Component<SelectComponentsprops,SelectComponentsState> {
    ...
    render() {
        const style=this.props.style===undefined?{width:170}:this.props.style;
